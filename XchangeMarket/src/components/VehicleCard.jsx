                        ...
                        <div className="flex flex-col items-end gap-1">
                            <div className="flex items-center gap-3 bg-white px-3 py-1 rounded-lg border border-gray-200 shadow-sm">
                                ...
                                <button
                                    ...
                                    className={`w-6 h-6 flex items-center justify-center rounded-full transition-colors font-bold ${
...
const VehicleCard = ({
    ...
    const isTechItem = badgeText !== "Vehicles";
                            ...
                            <div className="w-full md:w-1/2 p-4 md:p-6">
                                ...
                                {isTechItem ? (
                                    <button
                                        ...
                                        className={`w-full font-bold py-3 px-6 rounded-xl transition-all flex items-center justify-center gap-2 shadow-lg transition-all duration-300 ${
                                            offerPercentage === 'Unavailable'
